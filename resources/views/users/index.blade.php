            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-4">Tên đăng nhập</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">
                                @foreach ($user->roles()->pluck('desc') as $role)
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{$role}}</span>
                                @endforeach
                            </td>
            ...
            <form action="{{route('users.store')}}" method="POST">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="xxxxxx@gmail.com" required="">
                    </div>
                    <div><label for="roles" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Vai trò</label>
                        ...
                        <option selected="" value="{{$i}}">{{ $role }}</option>
                        @endforeach
                        </select>
                    </div>
                    <div>
